...
describe("FlowAtlas CLI upstream", () => {
  it("prints the upstream projection to an architectural node", async () => {
    ...
    expect(result.stdout).toContain("Focus: likeToggleUseCaseFactory");
